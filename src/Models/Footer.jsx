        ...
        <>
            ...
            <footer className="bg-black  pt-[80px]">
                ...
                ">
                    ...
                    <div className=' ml-4 min-w-50 w-50 w-auto'>
                    ...
                    <div className=" text-white space-y-4 pt-7 w-40 text-[1rem] xl:text-[1.3rem]  xl:space-y-6">
                        ...
                        <div className=" circularFont2 space-y-4">
                            ...
                            <div><a href="">Empregos</a></div>
                            <div><a href="">For the Record</a></div>
                        </div>
                    </div>

                    <div className=" text-white space-y-4 pt-20 text-[1rem]">
                    ...
                    <div className=" text-white pt-20 space-y-4">
                    ...
                    <div className=" pt-52 pb-5">
                        <ul className='flex  space-x-7 '>
                            <li>
                                <span role="img" aria-label="Instagram" class="mh-social-icon-instagram svelte-1ad7r0v"></span>
                    ...
                    <div className='text-footer flex text-[0.8rem] justify-end pr-2 space-x-3 items-center '>
                        <a  href="https://www.spotify.com/br/select-your-country-region/" class="mh-footer-secondary mh-compact svelte-1ouzkfx">
                    ...
                    <div className=" mt-10  text-[0.7rem]  text-footer flex">

                        <ul className='grid grid-cols-2 content-center'>
                        ...
                        <span class="ml-auto pr-3">© 2022 Spotify AB</span>
                    </div>
